...
/*
Package unumpb is a generated twirp stub package.
...
// NewUnumProtobufClient creates a Protobuf client that implements the Unum interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewUnumProtobufClient(addr string, client HTTPClient, opts ...twirp.ClientOption) Unum {
...
func (c *unumProtobufClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
...
func (c *unumProtobufClient) SendSMS(ctx context.Context, in *SendSMSRequest) (*SendSMSResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "unumpb")
	ctx = ctxsetters.WithServiceName(ctx, "Unum")
...
// NewUnumJSONClient creates a JSON client that implements the Unum interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewUnumJSONClient(addr string, client HTTPClient, opts ...twirp.ClientOption) Unum {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *unumJSONClient) Ping(ctx context.Context, in *PingRequest) (*PingResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "unumpb")
	ctx = ctxsetters.WithServiceName(ctx, "Unum")
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	out := new(PingResponse)
...
func (c *unumJSONClient) SendSMS(ctx context.Context, in *SendSMSRequest) (*SendSMSResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "unumpb")
	ctx = ctxsetters.WithServiceName(ctx, "Unum")
	ctx = ctxsetters.WithMethodName(ctx, "SendSMS")
	out := new(SendSMSResponse)
...
type unumServer struct {
	Unum
	hooks *twirp.ServerHooks
}

func NewUnumServer(svc Unum, hooks *twirp.ServerHooks) TwirpServer {
	return &unumServer{
		Unum:  svc,
		hooks: hooks,
	}
...
func (s *unumServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// UnumPathPrefix is used for all URL paths on a twirp Unum server.
// Requests are always: POST UnumPathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const UnumPathPrefix = "/twirp/unumpb.Unum/"

func (s *unumServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "unumpb")
	ctx = ctxsetters.WithServiceName(ctx, "Unum")
...
func (s *unumServer) servePing(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *unumServer) servePingJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	...
	func() {
		...
		respContent, err = s.Unum.Ping(ctx, reqContent)
	}()
...
func (s *unumServer) servePingProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Ping")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *unumServer) serveSendSMS(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveSendSMSJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveSendSMSProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *unumServer) serveSendSMSJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "SendSMS")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	// Call service method
	var respContent *SendSMSResponse
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.Unum.SendSMS(ctx, reqContent)
	}()
...
func (s *unumServer) serveSendSMSProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "SendSMS")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *unumServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *unumServer) ProtocGenTwirpVersion() string {
	return "v5.10.1"
}

func (s *unumServer) PathPrefix() string {
	return UnumPathPrefix
}
